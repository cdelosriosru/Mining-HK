...
foreach x in  2000  {
		foreach y in na re ri{		
			...
			esttab  `y'graduado`x'10000 `y'compr`x'10000 `y'deserted`x'10000 `y'desr`x'10000 using "${overleaf}/resultados/new_2022/school/mines/completion_desertion_10000", `appi' f ///
				label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
				star(* 0.10 ** 0.05 *** 0.01) ///
				cells(b(star fmt(3)) se(par fmt(2))) ///
				mtitle(  ) ///
...
foreach x in  2000  {
		foreach y in na re ri{		
			...
			esttab  `y'graduado`x'5000 `y'graduado`x'20000 `y'graduado`x'30000 `y'compr`x'5000 `y'compr`x'20000 `y'compr`x'30000 `y'deserted`x'5000 `y'deserted`x'20000 `y'deserted`x'30000 `y'deserted`x'10000 `y'desr`x'5000 `y'desr`x'20000 `y'desr`x'30000 using "${overleaf}/resultados/new_2022/school/mines/completion_desertion_buffers", `appi' f ///
				label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
				star(* 0.10 ** 0.05 *** 0.01) ///
				cells(b(star fmt(3)) se(par fmt(2))) ///
				mtitle(  ) ///
...
local appi replace
	...
	esttab   `x'_semestertohe_w1_`y' `x'_semestertohe_w2_`y'   using "${overleaf}/resultados/new_2022/individual/mines/res_semester_win_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
...
local appi replace
	...
	esttab  `x'_estudiantes_`y'    using "${overleaf}/resultados/new_2022/school/estudiantes_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
...
local appi replace
	...
	esttab   `x'_age_`y' `x'_age_w1_`y'  `x'_age_w2_`y'  `x'_age2_`y' `x'_age2_w1_`y'  `x'_age2_w2_`y'  using "${overleaf}/resultados/new_2022/individual/age_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
...
local appi replace
	...
	esttab   `x'_agesd_`y' `x'_age2sd_`y' `x'_age_w3_`y' `x'_age2_w3_`y'   using "${overleaf}/resultados/new_2022/individual/age95_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
		mtitle( "\specialcell{`x'_enroled_he_`y'}" "\specialcell{`x'_rent_seeker_`y'}" "\specialcell{`x'_pct2_`y'}" "\specialcell{`x'_universitario_`y'}" "\specialcell{`x'_semestertohe_`y'}") ///
...
local appi replace
	...
	esttab  `x'_enrolment_rate_`y' `x'_rentseeker_1_`y'  `x'_uni_1_`y'  using "${overleaf}/resultados/new_2022/school/pub32012_`y'", `appi' f ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
		mtitle( "\specialcell{Rent}" "\specialcell{`Uni'}" ) ///
...
local appi replace
	...
	esttab   `x'_pct2_`y' `x'_rent_seeker_`y'  `x'_semestertohe_`y'   using "${overleaf}/resultados/new_2022/individual/pub12012_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
		mtitle( "\specialcell{`x'_enroled_he_`y'}" "\specialcell{`x'_rent_seeker_`y'}" "\specialcell{`x'_pct2_`y'}" "\specialcell{`x'_universitario_`y'}" "\specialcell{`x'_semestertohe_`y'}") ///
	scalars(rkf)  sfmt(0 3)
		...
		esttab   `x'_norent_`y'    using "${overleaf}/resultados/new_2022/individual/pub22012_`y'", `appi' f  ///
		label booktabs b(3) p(3) eqlabels(none) alignment(S) noconstant ///
		star(* 0.10 ** 0.05 *** 0.01) ///
		cells(b(star fmt(3)) se(par fmt(2))) ///
